...
function SimpleWebRTC(opts) {
    ...
    var config = this.config = {
            ...
            media: {
                //video: true,
                "video": {"optional": [{"minWidth": "400"}, {"minHeight": "324"}, {"maxWidth": "400"}, {"maxHeight": "324"}]},
...
SimpleWebRTC.prototype.handlePeerStreamAdded = function (peer) {
    ...
    //if (container)  {
        ...
        jQuery('#remotes').append('<div style="float:left;" id="'+video.id+'-container" class="remote-video-container"></div>');
        jQuery('#'+video.id+'-container').append(video);
...
SimpleWebRTC.prototype.handlePeerStreamRemoved = function (peer) {
    ...
    if (this.config.autoRemoveVideos && container && videoEl) {
        ...
        jQuery('#'+videoEl.id+'-container').remove();
    }
...
SimpleWebRTC.prototype.stopLocalVideo = function () {
    ...
    //added by kosmos.by@gmail.com

    SimpleWebRTC.prototype.pauseLocalVideo = function () {
        this.webrtc.pauseVideo();
    };

    SimpleWebRTC.prototype.resumeLocalVideo = function () {
        this.webrtc.resumeVideo();
    };

    SimpleWebRTC.prototype.pauseLocalAudio = function () {
        this.webrtc.mute();
    };

    SimpleWebRTC.prototype.resumeLocalAudio = function () {
        this.webrtc.unmute();
    };


    SimpleWebRTC.prototype.stopLocalMedia = function () {
        this.webrtc.stopLocalMedia();
    };
