...
require=(function(e,t,n){function i(n,s){if(!t[n]){if(!e[n]){var o=typeof require=="function"&&require;if(!s&&o)return o(n,!0);if(r)return r(n,!0);throw new Error("Cannot find module '"+n+"'")}var u=t[n]={exports:{}};e[n][0].call(u.exports,function(t){var r=e[n][1][t];return i(r?r:t)},u,u.exports)}return t[n].exports}var r=typeof require=="function"&&require;for(var s=0;s<n.length;s++)i(n[s]);return i})({"templates":[function(require,module,exports){
    module.exports=require('HtB2r8');
},{}],"HtB2r8":[function(require,module,exports){
    (function () {
...
// enterPassword.jade compiled template
        exports.dialogs.enterPassword = function anonymous(locals) {
            var buf = [];
            with (locals || {}) {
                buf.push('<form class="password"><h2>This room requires a key</h2><p class="errorMessage"></p><input placeholder="•••••••" class="type"/><button type="button" class="cancel no-icon secondary">Cancel</button><button type="submit" class="go no-icon">Join</button></form>');
            }
            return buf.join("");
        };
...
// setPassword.jade compiled template
        exports.dialogs.setPassword = function anonymous(locals) {
            var buf = [];
            with (locals || {}) {
                buf.push('<form class="password"><h2>Set a key for this room</h2><p class="errorMessage"></p><input placeholder="your shared key" class="type"/><button type="button" class="no-icon cancel secondary">Cancel</button><button type="submit" class="no-icon go">Save</button></form>');
            }
            return buf.join("");
        };
...
// layout.jade compiled template
        exports.layout = function anonymous(locals) {
            var buf = [];
            with (locals || {}) {
                buf.push('<div class="wrap"><section id="pages"></section><!--footer.withad<a id="ad" href="http://andbang.com" target="_blank"></a><a id="andyet" href="http://andyet.com" target="_blank"><img src="/images/andyet.png" width="40"/></a>--></div>');
            }
            return buf.join("");
        };
...
// create.jade compiled template
        exports.pages.create = function anonymous(locals) {
            var buf = [];
            with (locals || {}) {
                buf.push('<section class="page create"><div class="room cf"><div><a href="/"><h1 id="logo"><img src="/images/talky.png" height="153" width="250" alt="Talky"/></h1></a><form id="createRoom"><p>Truly simple video chat and screen sharing for groups.</p><input id="sessionInput" placeholder="Name the conversation" autofocus="autofocus"/><button type="submit">Let’s go!</button></form></div></div><h2 class="intro">No plugins. No signup or payment required. <br/> Anonymous. Peer-to-peer.</h2><div class="features cf"><div class="feature"><h3>Group video chat</h3><p>Add multiple people to the conversation </p></div><div class="feature"><h3>Screen sharing</h3><p>Easily add anyone\'s screen to the conversation</p></div><div class="feature"><h3>Locked rooms</h3><p>Add a shared key to a room for added privacy</p></div><div class="feature"><h3>Rockets & stuff</h3><p>Play rocket lander while you wait for people to join</p></div></div><div class="works cf"><h2>Works in</h2><div class="browser"><figure><img src="/images/chrome.png" height="128" width="128" alt="Chrome"/></figure><figcaption>Chrome</figcaption></div><div class="browser"><figure><img src="/images/firefox.png" height="128" width="128" alt="Firefox"/></figure><figcaption>Firefox*</figcaption></div><p> <strong>*</strong>Screensharing available only in Chrome.</p></div><div class="quote cf"><blockquote>&#8220;Damn, Talky is awesome.&#8221;</blockquote><p> <a href="https://twitter.com/waxpancake" title="Andy Baio on Twitter">Andy Baio </a></p><p>From the <strong>Internet</strong></p></div><div class="awesome"><div class="cf"><h2>Help make WebRTC awesome by submitting your feedback.</h2><p>WebRTC is one of the most transformative additions to the web platform, but it\'s still early days.</p><p>By submitting anonymous feedback on a Talky call, you\'re helping provide data for browser vendors to improve the platform for the web.</p><p>Read more about this effort at <a href="http://iswebrtcreadyyet.com">isWebRTCreadyyet.com</a></p></div></div><div class="aboutUs cf"><div class="yetis"><a href="http://andyet.com"><img src="/images/andyet.png" width="110"/></a><p>Talky is built by <a href="http://andyet.com">&yet</a>, a bootstrapped open web software company from Richland, WA. We make web software for human people.</p><p>We get a lot of joy out of making the Internet a better place to live and work. Thanks for trying Talky!</p></div><div class="webrtc"><h2>Talky uses <a href="http://simplewebrtc.com">SimpleWebRTC</a>.<br/> And so can you!</h2><p>Talky is built entirely on open-source SimpleWebRTC toolkit.</p><p>SimpleWebRTC is intended to be fully interoperable with any signaling platform (open source servers like SignalMaster, federated protocols like XMPP, and commercial products).</p></div></div><footer class="landing"><ul><li> <a href="help" title="Helpful information">Helpful information</a></li><li><a href="http://twitter.com/usetalky" title="Talky on Twitter">@UseTalky</a></li><li><a href="mailto:support@talky.io" title="Contact Support">Contact support</a></li><li><a href="http://apps.andyet.com/legal" title="Legal, Privacy, Contact links">Legal, Privacy, Contact</a></li></ul></footer></section>');
            }
            return buf.join("");
        };
...
// feedback.jade compiled template
        exports.pages.feedback = function anonymous(locals) {
            var buf = [];
            with (locals || {}) {
                buf.push('<section class="page feedback"><div><form id="feedbackForm"><div class="yesNo"><input type="hidden" name="wasHighQuality"/><h2 class="mainQuestion"> \nWas your call experience high quality?</h2><div class="choice"><button type="button" class="secondary yes">Yes</button><span class="or">or</span><button type="button" class="secondary no">No</button></div><p>We\'re reporting your <strong>anonymous feedback</strong> to browser vendors and <a href="http://iswebrtcreadyyet.com" target="_blank">publishing it</a>, which will help make WebRTC better for everyone.</p></div><hr/><div class="details"><h4>Any problems? <span>(Optional)</span></h4><fieldcontainer class="audio"><p><input id="echo" type="checkbox" name="echo"/><label for="echo">There was echo</label></p><p><input id="cantHearThem" type="checkbox" name="cantHearThem"/><label for="cantHearThem">I couldn\'t hear them</label></p><p><input id="cantHearMe" type="checkbox" name="cantHearMe"/><label for="cantHearMe">They couldn\'t hear me</label></p></fieldcontainer><fieldcontainer class="video"><p><input id="cantSeeThem" type="checkbox" name="cantSeeThem"/><label for="cantSeeThem">I couldn\'t see them</label></p><p><input id="cantSeeMe" type="checkbox" name="cantSeeMe"/><label for="cantSeeMe">They couldn\'t see me</label></p></fieldcontainer></div><hr/><div class="button-container send-feedback"><button type="submit" class="no-icon submit">Send feedback</button></div></form><p class="more-feedback"><strong>Have more thoughts? </strong>We’d love to hear from you: <a href="mailto:support@talky.io">support@talky.io</a></p><footer><a href="/" class="talky-logo"><img src="/images/talky.png"/></a><a href="http://andyet.com" class="andyet"><img src="/images/andyet.png"/></a></footer></div></section>');
            }
            return buf.join("");
        };
...
// talk.jade compiled template
        exports.pages.talk = function anonymous(locals) {
            var buf = [];
            with (locals || {}) {
                buf.push('<section class="page talk"><div class="trial"><p>Talky is powered by a new web technology called WebRTC. Please provide <a class="btn feedback" href="#">Feedback</a> to make it better. </p><a href="" class="ss-icon close">close</a></div><div class="topbar"><a href="/" id="logo"><h1><img src="/images/talky-logotype.png" height="31" width="50" alt="Talky"/></h1></a><h2><span id="title" class="roomName"></span></h2><div id="roomLink"><a title="Copy room link" class="btn ss-icon secondary copyRoomLink">link</a><div class="lockControls"><a href="#" class="unlock btn secondary"> <i class="ss-icon ss-unlock"></i>Unlock Room</a><a href="#" class="lock btn secondary"> <i class="ss-icon ss-lock"></i>Lock Room</a><span id="roomKey">Room key</span></div></div><div class="controls"><button id="shareScreen"><span class="share"><i class="ss-icon">windows </i>Share screen</span><span class="unshare"><i class="ss-icon">windows</i>Unshare screen</span></button><button id="muteMicrophone"><span class="mute"><i class="ss-icon">volume</i>Mute</span><span class="unmute"><i class="ss-icon">volumehigh</i>Unmute</span></button><button id="pauseVideo"><span class="pause"><i class="ss-icon">pause  </i>Pause</span><span class="resume"><i class="ss-icon">play  </i>Resume</span></button><button id="endCall"><span class="end"><i class="ss-icon ss-delete"> </i>Leave Call</span></button><ul class="profileDropDown"><li class="has-dropdown"><a href="/me" class="me"> <img height="20" width="20" class="userAvatar"/><span class="profileName"></span><i class="ss-icon ss-dropdown"></i></a><ul class="dropdown"><li><a href="/logout">Log out</a></li></ul></li></ul></div></div><video id="localVideo" autoplay="autoplay"></video><div id="remotes"></div><h2 class="joinMe">Others can join you just by going to<br/><span class="appUrl">' + jade.escape((jade.interp = window.location.origin) == null ? "" : jade.interp) + '</span>/<span class="roomName"></span></h2><div id="game"><aside id="instructions" style="position: absolute"><h3>Play lander while you wait for people to join!</h3><ul><li>Arrow keys control the ship</li><li><code>r</code> restarts</li><li><code>x</code> blows up your ship</li></ul><p>Have fun!</p></aside><canvas id="viewport"></canvas></div><a id="Intercom" class="feedback">Feedback</a><div id="timerBox"><p>screen sharing time remaining: <strong id="timerValue"></strong></p></div></section>');
            }
            return buf.join("");
        };
...
// thanks.jade compiled template
        exports.pages.thanks = function anonymous(locals) {
            var buf = [];
            with (locals || {}) {
                buf.push('<section class="page thanks"><div class="thankswrap"><h2>Thank you!</h2><p>Your feedback will be used to make WebRTC better for everyone.</p><p>If you like Talky and want to see WebRTC get better, help spread the word!</p><a href="https://twitter.com/share" data-lang="en" data-url="http://talky.io" data-text="Truly simple video chat and screen sharing in your browser with @usetalky:" data-related="usetalky" class="twitter-share-button">Tweet</a><div href="https://talky.io" data-action="share" class="g-plus"></div><a href="/" class="new-call btn">Start another call</a></div><script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="https://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");\n</script><script>(function() {\n    var po = document.createElement(\'script\'); po.type = \'text/javascript\'; po.async = true;\n    po.src = \'https://apis.google.com/js/plusone.js\';\n    var s = document.getElementsByTagName(\'script\')[0]; s.parentNode.insertBefore(po, s);\n})();\n</script></section>');
            }
            return buf.join("");
        };
...
},{"fs":1}],"shippyAd":[function(require,module,exports){
    module.exports=require('l75i+R');
},{}],"l75i+R":[function(require,module,exports){
...
},{}],"fluidGrid":[function(require,module,exports){
    module.exports=require('qHkKRD');
},{}],"qHkKRD":[function(require,module,exports){
    (function () {
// reference to our currently focused element
    ...
    module.exports=require('3ZfLz8');
},{}],"3ZfLz8":[function(require,module,exports){
...
},{"tracking":"OliKPz"}],1:[function(require,module,exports){
...
},{"./models/me":3,"./router":5,"./views/main":4,"backbone":6,"clientconfig":9,"cookie-getter":8,"sound-effect-manager":7,"talky":"y85iEV","tracking":"OliKPz","webrtcsupport":10}],7:[function(require,module,exports){
    (function(){/*
     SoundEffectManager
...
},{}],"talky":[function(require,module,exports){
    module.exports=require('y85iEV');
},{}],"y85iEV":[function(require,module,exports){
...
},{"simplewebrtc":11,"wildemitter":12}],10:[function(require,module,exports){
...
// simple commonJS cookie reader, best perf according to http://jsperf.com/cookie-parsing
    ...
    module.exports=require('OliKPz');
},{}],"OliKPz":[function(require,module,exports){
...
},{"./intercom":"K1xQwI","clientconfig":9}],"intercom":[function(require,module,exports){
    module.exports=require('K1xQwI');
},{}],"K1xQwI":[function(require,module,exports){
...
},{"clientconfig":9}],12:[function(require,module,exports){
    /*
...
},{"./pages/create":13,"./pages/feedback":15,"./pages/talk":14,"./pages/thanks":16,"backbone":6}],16:[function(require,module,exports){
...
},{"./base":17,"templates":"HtB2r8"}],3:[function(require,module,exports){
...
},{"strictmodel":18}],4:[function(require,module,exports){
...
},{"clientconfig":9,"shippyAd":"l75i+R","strictview":19,"templates":"HtB2r8","underscore":20}],9:[function(require,module,exports){
...
},{"cookie-getter":8}],6:[function(require,module,exports){
    ...
    (function(){/*global app, ui, $, me*/
        ...
        module.exports = BasePage.extend({
            ...
            initialize: function () {
                ...
                me.on('change:sharingScreen', _.bind(this.handleScreenSharingChanged, this));
                ...
                if (me.sharingScreen) {
                    ...
                    if (me.isPaid || !me.hasSharedScreen) {
                        if (!app.api.capabilities.screenSharing) {
                            ...
                            app.api.webrtc.peers.forEach(function (peer) {
                                if (peer.browserPrefix === 'moz') {
                                    canShare = false;
                                }
                            });
                            if (!canShare) {
                                this.showChromeScreenShareWarning();
                            }
            ...
            showChromeScreenShareWarning: function () {
                _.delay(function () {
                    $.showMessage('Only users on Chrome will be able to see your screen.', {delay: 3000});
                }, 6000);
            },
            handleMuteClick: function () {
                if (webrtcsupport.prefix === 'moz') {
                    $.showMessage('Sorry, muting is currently only available in Chrome');
                    return;
                }
                if (me.muted) {
                    me.muted = false;
            ...
            handlePauseClick: function () {
                if (webrtcsupport.prefix === 'moz') {
                    $.showMessage('Sorry, pausing is currently only available in Chrome');
                    return;
                }
                if (me.paused) {
                    me.paused = false;
            ...
            startGame: function (force) {
                if (!me.passwordDialog && !this.$('#remotes video').length || force) {
                    ...
                    $.getScript('/js/Box2d.min.js', function () {
                        $.getScript('/js/out.js');
                    });
                }
            },
            ...
            handleVideoAdded: function (el, peer) {
                ...
                if (peer) {
                    ...
                    if (me.sharingScreen && peer.browserPrefix === 'moz') {
                        this.showChromeScreenShareWarning();
                    }
                }
            ...
            handleScreenSharingChanged: function () {
                return;

                /*
                 var el = this.$('#timerBox');
                 var timerSpan = this.$('#timerValue');
                 var self = this;
                 var video = this.$('#localScreen')[0];

                 if (me.sharingScreen && !me.isPaid) {
                 this.timer = new Timer({
                 direction: 'down',
                 startValue: config.screenShareTimeout
                 });

                 el.addClass('active');

                 this.timer.on('change', function (val) {
                 timerSpan.text(val);
                 });
...
},{"./base":17,"clientconfig":9,"fluidGrid":"qHkKRD","intercom":"K1xQwI","redirectToSystemRequirements":"3ZfLz8","templates":"HtB2r8","time-counter":21,"tracking":"OliKPz","underscore":20,"webrtcsupport":10}],13:[function(require,module,exports){
    (function(){/*global app, $, me*/
        var BasePage = require('./base'),
            templates = require('templates'),
            tracking = require('tracking'),
...
},{"./base":17,"clientconfig":9,"slugger":22,"templates":"HtB2r8","tracking":"OliKPz","underscore":20}],15:[function(require,module,exports){
...
},{"./base":17,"clientconfig":9,"templates":"HtB2r8","tracking":"OliKPz","underscore":20}],23:[function(require,module,exports){
...
},{"attachmediastream":26,"getscreenmedia":24,"mockconsole":23,"webrtc":25,"webrtcsupport":10,"wildemitter":12}],22:[function(require,module,exports){
...
},{"backbone":6,"underscore":20}],19:[function(require,module,exports){
    var Backbone = require('backbone'),
        _ = require('underscore'),
        templates = require('templates');
...
},{"backbone":6,"templates":"HtB2r8","underscore":20}],17:[function(require,module,exports){
    (function(){/*global app, $*/
...
},{"strictview":19,"underscore":20}],21:[function(require,module,exports){
    var WildEmitter = require('wildemitter');
...
},{"wildemitter":12}],25:[function(require,module,exports){
...
},{"getusermedia":30,"hark":27,"mediastream-gain":28,"mockconsole":23,"rtcpeerconnection":29,"webrtcsupport":10,"wildemitter":12}],24:[function(require,module,exports){
...
},{"getusermedia":31}],30:[function(require,module,exports){
...
},{"wildemitter":12}],28:[function(require,module,exports){
...
},{"webrtcsupport":10}],29:[function(require,module,exports){
    var WildEmitter = require('wildemitter');
    var webrtc = require('webrtcsupport');
...
},{"webrtcsupport":32,"wildemitter":12}],32:[function(require,module,exports){
// created by @HenrikJoreteg
    var PC = window.mozRTCPeerConnection || window.webkitRTCPeerConnection || window.RTCPeerConnection;
    var IceCandidate = window.mozRTCIceCandidate || window.RTCIceCandidate;
    var SessionDescription = window.mozRTCSessionDescription || window.RTCSessionDescription;
