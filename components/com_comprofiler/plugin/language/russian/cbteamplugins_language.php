...
'%s updated their profile'				=>	'%s обновили их профиль',
...
'ONLINE'								=>	'НА ЛИНИИ СВЯЗИ',
'OFFLINE'								=>	'ВНЕ ЛИНИИ СВЯЗИ',
'Online Status: '						=>	'Статус связи: ',
...
CBTxt::addStrings( array(
'Facebook'									=>	'Facebook',
'Synced from Facebook; do not change here, but at Facebook as: %s'											=>	'Синхронизирован с Facebook; меняйте не здесь, но на Facebook как: %s',
'Profile Image'								=>	'Картинка профиля',
'First, Middle, and Last Name'				=>	'Имя, Отчество и Фамилия',
'First Name'								=>	'Имя',
'Last Name'									=>	'Фамилия',
'About Me'									=>	'Обо мне',
...
'Political View'							=>	'Политические взгляды',
'Favorite Quotes'							=>	'Любимая цитата',
'Relationship Status'						=>	'Статут отношений',
'Religious Views'							=>	'Религиозные взгляды',
'Sex'										=>	'Пол',
'Status'									=>	'Статус',
'Favorite TV Shows'							=>	'Любимые теле-шоу',
'View Facebook Profile'						=>	'Смотреть профиль на Facebook',
'Connect this account to your Facebook account'																=>	'Соединить эту учетную запись с Вашей учетной записью на Facebook',
'Link'										=>	'Ссылка',
'Login with your Facebook account'			=>	'Войти на сайт с Вашей учетной записью Facebook',
'Sign in'									=>	'Записаться',
'Are you sure you want to unlink this account from your Facebook account?'									=>	'Вы действительно хотите отделить эту Вашу учетную запись от Вашей учетной записи на Facebook?',
'Unlink this account from your Facebook account'															=>	'Отделить эту учетную запись от Вашей учетной записи на Facebook',
'Unlink'									=>	'Отделить',
'Please change your password from profile edit before unlinking to allow further login after unlinked.'	=>	'Для дальнейшего успешного входа на сайт после разделения учетных записей, прежде чем разделять учетные записи, пожалуйста измените Ваш пароль, пользуясь редактированием профиля.',
'Please change your email from profile edit before unlinking to allow further login after unlinked.'		=>	'Для дальнейшего успешного входа на сайт после разделения учетных записей, прежде чем разделять учетные записи, пожалуйста измените адрес Вашей эл.почты, используя редактирование профиля.',
'Would you like to do this now?'			=>	'Вы хотите сделать это сейчас?',
'Facebook account successfully unlinked!'	=>	'Учетная запись Facebook успешно отделена!',
'Facebook account successfully linked!'		=>	'Ссылка на учетную запись Facebook успешно создана!',
...
CBTxt::addStrings( array(
'Twitter'											=>	'Twitter',
'Synced from Twitter; do not change here, but at Twitter as: '												=>	'Синхронизировано с Twitter; ничего не изменяйте здесь, но на Twitter как: ',
'Picture'											=>	'Картинка',
'Name'												=>	'Имя',
'View Twitter Profile'								=>	'Смотреть профиль на Twitter',
'Connect this account to your Twitter account'		=>	'Соединить эту Вашу учетную запись с Вашей учетной записью на Twitter',
'Link'												=>	'Ссылка',
'Login with your Twitter account'					=>	'Зайти на сайт с Вашей Twitter-вской учетной записью',
'Sign in'											=>	'Записаться',
'Are you sure you want to unlink this account from your Twitter account?'									=>	'Вы действительно хотите разделить эту Вашу учетную запись от Вашей учетной записи на Twitter?',
'Unlink this account from your Twitter account'		=>	'Разделить эту Вашу учетную запись от Вашей учетной записи на Twitter',
'Unlink'											=>	'Разделить',
'Please change your password from profile edit before unlinking to allow further login after unlinked.'	=>	'Для дальнейшего успешного входа на сайт после разделения учетных записей, прежде чем разделять учетные записи, пожалуйста измените Ваш пароль, пользуясь редактированием профиля.',
'Please change your email from profile edit before unlinking to allow further login after unlinked.'		=>	'Для дальнейшего успешного входа на сайт после разделения учетных записей, прежде чем разделять учетные записи, пожалуйста измените адрес Вашей эл.почты, используя редактирование профиля.',
'Would you like to do this now?'					=>	'Вы действительно хотите сделать это сейчас?',
'Twitter account successfully unlinked!'			=>	'Ваша учетная запись на Twitter была успешно отделена!',
'Twitter account successfully linked!'				=>	'Ваша учетная запись на Twitter была успешно присоединена!',
'Twitter credentials failed to load.'				=>	'Данные Вашей учетной записи от Twitter не загрузились!'
));
