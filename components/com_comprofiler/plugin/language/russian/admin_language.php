...
* @version $Id: admin_english.php$
* @package Community Builder
* @subpackage Core CB Admin English Language file
* @since 1.2.3
* @author Nick A. (nant) and Beat
* Русский перевод выполнен Александром Смирновым и командой русско-язычных переводчиков СВ на forge.joomlapolis.com
...
'Show the subject field. If hidden, subject will be &quot;Message from your profile view&quot; = _UE_PM_PROFILEMSG' => 'Показывать поле названия темы. Если скрыто, заголовком будет &quot;Сообщение из Вашего просмотра профиля???w&quot; = _UE_PM_PROFILEMSG',
...
'Warning: %s entries in the users table without corresponding core_acl_aro table rows.' => 'Предупреждение: в таблице пользователей содержится %s записей, которые не имеют соответствующих записей в таблице corresponding core_acl_aro.',
...
'All users table rows have ACL entries in core_acl_aro table.' => 'Все записи таблицы пользователей обладают записями ACL в таблице core_acl_aro.',
'Warning: %s entries in the core_acl_aro table without corresponding users table rows.' => 'Предупреждение:  в таблице core_acl_aro находятся %s записей, которые не имеют соответствующих записей в таблице пользователей.',
'Following entries of core_acl_aro table are missing in users table: %s.' => 'Следующие записи в таблице core_acl_aro отсутствуют в таблице пользователей: %s.',
...
'All ACL core_acl_aro table rows have corresponding entries in users table.' => 'Все записи таблицы core_acl_aro обладают соответствующими записями в таблице пользователей.',
...
'Not a valid input' => 'Не правильный ввод данных',
...
'Forum Posts' => 'Сообщения форума',
'Last %s Forum Posts' => 'Последние %s сообщения форума',
