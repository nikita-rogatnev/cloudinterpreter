...
* @version $Id: default_language.php 1040 2010-06-07 14:07:06Z beat $
* @package Community Builder
* @subpackage Default Language file (English)
* @author JoomlaJoe and Beat
* Русский перевод выполнен Александром Смирновым и командой русских переводчиков СВ на forge.joomlapolis.com
...
DEFINE('_UE_EDIT_TITLE','Редактировать Ваши данные');
...
DEFINE('_UE_WELCOME_DESC','Добро пожаловать на раздел пользователя нашего сайта.');
DEFINE('_UE_CONF_CHECKED_IN','Все заблокированные материалы сейчас были разблокированы.');
DEFINE('_UE_CHECK_TABLE','Проверяется таблица');
DEFINE('_UE_CHECKED_IN','Заблокировать');
DEFINE('_UE_CHECKED_IN_ITEMS',' материалов');
DEFINE('_UE_PASS_MATCH','Пароли не сходятся');
DEFINE('_UE_USERNAME_DESC','Установите на "Да" чтобы позволить изменение имени пользователя. Если настроено на "Нет", то после регистрации имя пользователя будет неизменяемым.');
...
DEFINE('_UE_MEMBERSINCE','Стал(а) членом');
DEFINE('_UE_LASTONLINE','Последний вход на сайт');
DEFINE('_UE_ONLINESTATUS','Статус линии связи');
DEFINE('_UE_ISONLINE','НА ЛИНИИ');
DEFINE('_UE_ISOFFLINE','ВНЕ ЛИНИИ');
...
DEFINE('_UE_CONTACT_INFO_HEADER','Контактная информация');
...
DEFINE('_UE_ALLOW_IM','Ссылки на IM');
DEFINE('_UE_ALLOW_IM_DESC','Разрешить ссылки на IM');
DEFINE('_UE_ALLOW_ONLINESTATUS','Статус линии связи');
DEFINE('_UE_ALLOW_ONLINESTATUS_DESC','Показать статус линии связи.');
...
.'<p>Ваше регистрация требует одобрения. По одобрению Ваш пароль будет отправлен Вам по введенному Вами адресу эл.почты.</p>'
...
DEFINE('_UE_REGISTER','Зарегистрируйтесь!');
...
DEFINE('_UE_REPORTUSER','Жаловаться на пользователя');
...
DEFINE('_UE_USERREPORT_SUCCESSFUL','Жалоба пользователя успешно отправлена.');
...
DEFINE('_UE_UPLOAD_PEND_APPROVAL','Ваша картинка в настоящее время ожидает одобрения модератором.');
DEFINE('_UE_UPLOAD_SUCCESSFUL','Ваша картинка была успешно загружена.');
...
DEFINE('_UE_BANUSER_MSG','Ваш пользовательский профиль был заблокирован администратором. Пожалуйста зайдите на сайт и рассмотрите почему.');
...
//Alpha 3 Build
DEFINE('_UE_IMAGE','Картинка профиля');
...
DEFINE('_UE_SENDPMSNOTICE','ЗАМЕТКА: Это сообщение создано автоматически системой связи. В нем находится адрес подсоединяющегося пользователя, чтобы Вам можно было удобно ответить, если Вы пожелаете.');
...
DEFINE('_UE_REG_REJECT_SUB','Ваше регистрация была отклонена!');
DEFINE('_UE_USERREJECT_MSG',"Ваше регистрация на %s была отклонена по следующей причине:\n%s");
...
.'<p>Ваша регистрация требует подтверждения через эл.почту и утверждения. Пожалуйста следуйте пошаговым инструкциям, присланным Вам по эл.почте. По утверждению, по введенному Вами адресу Вам будет отправлено записка о принятии.</p>'
.'<p>Вы сможете войти на сайт, когда Вы получите одобрение.</p>');
...
DEFINE('_UE_ARTICLETITLE','Титул');
DEFINE('_UE_ARTICLERATING','Рейтинг');
DEFINE('_UE_ARTICLEHITS','Хиты');
...
//Connections
DEFINE('_UE_ADDCONNECTION','Добавить связь');
DEFINE('_UE_REMOVECONNECTION','Удалить связь');
DEFINE('_UE_CONNECTION','Связи');
DEFINE('_UE_CONNECTIONACCEPTSUCCESSFULL','Связь успешно принята!');
DEFINE('_UE_CONNECTIONREMOVESUCCESSFULL','Связь успешно удалена!');
DEFINE('_UE_CONNECTIONADDSUCCESSFULL','Связь успешно добавлена!');
DEFINE('_UE_CONNECTIONPENDINGACCEPTANCE','Связь ожидает принятия!');
DEFINE('_UE_DIRECTCONNECTIONPENDINGACCEPTANCE','Прямая связь с %s ожидает принятия!');
DEFINE('_UE_NOCONNECTIONS','Этот пользователь в настоящее время не имеет связей.');
DEFINE('_UE_NODIRECTCONNECTION','Прямая связь отсутствует.');
DEFINE('_UE_ACCEPTCONNECTION','Принять связь');
DEFINE('_UE_CONNECTIONPENDING','Связь ожидает одобрения');
DEFINE('_UE_CONNECTEDSINCE','Соединен(а) начиная с');
DEFINE('_UE_CONNECTEDCOMMENT','Комментарий');
DEFINE('_UE_CONNECTEDDETAIL','Подробности связи');
DEFINE('_UE_CONNECTIONREQUESTDETAIL','Подробности запроса связи');
DEFINE('_UE_CONNECTIONREQUIREDON','Связь востребована');
DEFINE('_UE_DECLINECONNECTION','Отклонить связь');
...
DEFINE('_UE_CONNECTIONSUPDATEDSUCCESSFULL','Ваша связь была успешно обновлена!');
DEFINE('_UE_MANAGECONNECTIONS','Управлять связями');
DEFINE('_UE_MANAGEACTIONS','Управлять действиями');
DEFINE('_UE_CONNECTIONACTIONSSUCCESSFULL','Действия связи успешны!');
DEFINE('_UE_ALLOWCONNECTIONS','Задействовать связи');
DEFINE('_UE_ALLOWCONNECTIONS_DESC','Включение этой функции позволит Вашим пользователям устанавливать связи друг с другом. Это обычно называют системой друзей или buddy-buddy.');
DEFINE('_UE_USEMUTUALCONNECTIONACCEPTANCE','Взаимное согласие');
DEFINE('_UE_USEMUTUALCONNECTIONACCEPTANCE_DESC','Включение этой функции требует чтобы до официального установления  связи обе стороны согласились на начальную связь.');
DEFINE('_UE_CONNECTOINNOTIFYTYPE','Метод извещения');
DEFINE('_UE_CONNECTOINNOTIFYTYPE_DESC','Выберите хотите ли Вы получать извещения о связи и каким образом Вы бы хотели чтобы Ваши пользователи получали извещения о процессе связи.');
DEFINE('_UE_AUTOADDCONNECTIONS','Перекрестные связи');
DEFINE('_UE_AUTOADDCONNECTIONS_DESC','Включение этой функции создаст связь для обеих сторон вместо связи только для запрашивающей стороны.');
DEFINE('_UE_CONNECTIONCATEGORIES','Категории связей');
DEFINE('_UE_CONNECTIONCATEGORIES_DESC','Введите список категорий, чтобы разрешить Вашим пользователям глубже категоризировать их связи. После ввода каждой категории нажмите на "Enter".');
DEFINE('_UE_CONNECTIONMADESUB','%s соединился с Вами!');
DEFINE('_UE_CONNECTIONMADEMSG','%s установил связь с Вами.');
...
DEFINE('_UE_CONNECTIONPENDSUB','%s ожидает одобрения связи с Вами!');
DEFINE('_UE_CONNECTIONPENDMSG','%s запрашивает связь с Вами и ожидает Вашего одобрения. Пожалуйста примите эту связь или откажите ее запросу.');
DEFINE('_UE_CONNECTTO','Соединиться с %s');
DEFINE('_UE_CONNECTEDWITH','Управлять связями со мной');
DEFINE('_UE_NOCONNECTEDWITH','Сейчас ни один пользователь не связан с Вами.');
DEFINE('_UE_CONNECTIONDENIED_SUB','Запрос о связи отклонен!');
DEFINE('_UE_CONNECTIONDENIED_MSG','Ваш запрос о связи с  %s был отклонен!');
DEFINE('_UE_CONNECTIONREMOVED_SUB','Связь удалена!');
DEFINE('_UE_CONNECTIONREMOVED_MSG','%s удалил(а) Вашу связь!');
DEFINE('_UE_CONNECTIONACCEPTED_SUB','Запрос о связи принят!');
DEFINE('_UE_CONNECTIONACCEPTED_MSG','Ваш запрос о связи с  %s был принят!');
DEFINE('_UE_CONNECTIONDENYSUCCESSFULL','Связь была успешно отклонена!');
DEFINE('_UE_TOC_LINK','Принять %sУсловия и Соглашения%s');	// to link only the "Terms and Conditions", first %s will be replaced by <a.. and second %s by </a>.
...
DEFINE('_UE_CONNECTIONDISPLAY_DESC','Выберите показывать ли связь каждого пользователя всем или лично.');
DEFINE('_UE_CONNECTIONPATH','Показывать степень связи');
DEFINE('_UE_CONNECTIONPATH_DESC','Выберите показывать ли степень связи между пользователем и посещаемым им профилем.');
DEFINE('_UE_DIRECTCONNECTION','Вы напрямую связаны с ');
DEFINE('_UE_NOESTABLISHEDCONNECTION','Отсутствует прямая личная связь между Вами и  ');
DEFINE('_UE_CONNECTIONPATH1','Ваш уровень связи с  ');
DEFINE('_UE_CONNECTIONPATH2','уровень ):<br />');
DEFINE('_UE_DETAILSABOUT',' Подробности о ');
DEFINE('_UE_CONNECTIONINVITATIONMSG','Настройте индивидуально Ваше приглашение к связи, добавив сообщение, которое будет включено в Вашу связь.');
DEFINE('_UE_MESSAGE','Сообщение:');
DEFINE('_UE_SENDCONNECTIONREQUEST','Отправить');
DEFINE('_UE_CANCELCONNECTIONREQUEST','Отменить');
DEFINE('_UE_CONFIRMREMOVECONNECTION','Вы действительно хотите удалить эту связь?');
DEFINE('_UE_CONNECTIONREQUIREACTION','Запрос связи(ей)');
...
DEFINE('_UE_YOUR_VERSION','Ваше версия');
...
DEFINE('_UE_CONNECT_MANAGECONNECTIONS','Внизу Вы видите пользователей с которыми Вы имеете связи напрямую. '
.'Вы можете добавить личный комментарий и выбрать несколько типов связей из списка щелкая по ним с помощью CTRL (на PC) или CMD (на Mac). '
.'Затем щелкните на кнопку "Обновить". '
.'Подвигайте и подержите указатель мыши над иконками чтобы посмотреть короткое пояснение их значения и действий, и над картинками чтобы посмотреть подробности связей.');
...
DEFINE('_UE_MENU_CONNECTIONS', 'Связи');
...
DEFINE('_UE_MENU_UPDATEAVATAR_DESC', 'Измените картинку Вашего профиля');
//DEFINE('_UE_MENU_DELETE_AVATAR', 'Remove Image');
DEFINE('_UE_MENU_DELETE_AVATAR_DESC', 'Удалите картинку из Вашего профиля');
...
DEFINE('_UE_ADDCONNECTION_DESC','Добавить связи к этому пользователю');
DEFINE('_UE_ADDCONNECTIONREQUEST','Запросить связь');
DEFINE('_UE_ADDCONNECTIONREQUEST_DESC','Запросите связь с этим пользователем');
DEFINE('_UE_REMOVECONNECTION_DESC','Удалить связь с этим пользователем');
DEFINE('_UE_REVOKECONNECTIONREQUEST','Забрать назад запрос связи');
DEFINE('_UE_REVOKECONNECTIONREQUEST_DESC','Отозвать запрос связи с этим пользователем');
DEFINE('_UE_MENU_MANAGEMYCONNECTIONS','Управлять связями');
DEFINE('_UE_MENU_MANAGEMYCONNECTIONS_DESC','Управляйте здесь действиями по Вашим существующим и ожидающим одобрения связям');
...
DEFINE('_UE_MENU_BANPROFILE_DESC', 'Как модератор сайта: Заблокировать этот профиль, сделав его невидимым другим пользователям');
//DEFINE('_UE_MENU_UNBANPROFILE','Unban Profile');
DEFINE('_UE_MENU_UNBANPROFILE_DESC', 'Как модератор сайта: Разблокировать этот профиль, сделав его видимым другим пользователям');
//DEFINE('_UE_MENU_REPORTUSER','Report User');
DEFINE('_UE_MENU_REPORTUSER_DESC', 'Пожалуйтесь здесь на этого пользователя модератору сайта чтобы он мог принять соответствующие меры');
...
DEFINE('_UE_ONLINESTATUS_DESC','Нынешний статус линии связи этого пользователя');
...
DEFINE('_UE_CONNECTIONPATHS','Пути связи');
...
DEFINE('_UE_YOURCONNECTIONS','Ваши связи');
DEFINE('_UE_USERSNCONNECTIONS','Связи пользователя %s');
DEFINE('_UE_SEEALLNCONNECTIONS','Посмотреть все связи пользователя %s');
DEFINE('_UE_SEEALLOFUSERSNCONNECTIONS','Посмотреть все %s связи пользователя %s');
...
DEFINE('_UE_UPLOAD_DIMENSIONS_AVATAR','Размер Вашей картинки будет при необходимости автоматически изменен как максимум на %s пикселей ширины и %s пикселей высоты, но на диске ей разрешено занимать не более %s KB.');
...
DEFINE('_UE_NEWPASS_MSG','Учетной записи пользователя назначен адрес эл.почты %s.\n'
.'Пользователь на %s только что запросил отправку нового пароля.\n\n'
.'Ваш новый пароль: %s\n\n'
.'Если это не Ваш запрос, не беспокойтесь.'
.' Это сообщение видимо Вам, но не им. Если это ошибка, просто войдите на сайт с Вашим'
.' новым паролем и затем измените его согласно Ваших предпочтений.');
...
DEFINE('_UE_VALID_PASS','Пожалуйста введите действительный пароль, без пробелов, длинной как минимум из 6 знаков и состоящее только из заглавные и маленькие буквы, числа и специальные знаки.');
DEFINE('_UE_VALID_PASS_CHARS','Пожалуйста введите действительное значение %s. без пробелов, длинной как минимум из %s знаков и содержащее заглавные и маленькие буквы, числа и специальные знаки.');
...
DEFINE ('_UE_AVATAR_NONE','Картинка профиля отсутствует');
DEFINE ('_UE_AVATAR_NO_CHANGE','Картинка не изменилась');
DEFINE ('_UE_AVATAR_UPLOAD','Загрузить картинку профиля');
DEFINE ('_UE_AVATAR_UPLOAD_NEW','Загрузить новую картинку профиля');
DEFINE ('_UE_AVATAR_SELECT','Выберите картинку в галерее');
DEFINE ('_UE_HAS_PROFILE_IMAGE','Имеет картинку профиля');
DEFINE ('_UE_HAS_NO_PROFILE_IMAGE','Не имеет картинки профиля');
...
DEFINE('_UE_FB_TABTITLE', 'Настройка форума' );
DEFINE('_UE_FB_ORDERING_OLDEST', 'Сначала старейшие сообщения' );
DEFINE('_UE_FB_ORDERING_LATEST', 'Сначала новейшие сообщения' );
DEFINE('_UE_FB_ORDERING_TITLE', 'Порядок сообщений' );
DEFINE('_UE_FB_SIGNATURE', 'Подпись вашей доски' );
DEFINE('_UE_FB_VIEWTYPE_FLAT', 'Смотреть плоско' );
DEFINE('_UE_FB_VIEWTYPE_THREADED', 'Смотреть нанизанными' );
DEFINE('_UE_FB_VIEWTYPE_TITLE', 'Предпочтенный тип просмотра' );
...
DEFINE('_UE_FB_REMOVE_FAVORITE_THREAD',':: Удалить излюбленные темы ::');
DEFINE('_UE_FB_NO_FAVORITES_FOUND','Ваших излюбленных тем не найдено');
DEFINE('_UE_FB_REMOVE_FAVORITES_ALL','Удалить все Ваши излюбленные темы');
DEFINE('_UE_FB_CONFIRMUNFAVORITEALL','Вы действительно хотите удалить Ваши возлюбленные темы?');

// 1.2 CB Team extensions
DEFINE('_UE_PROFILE_GALLERY','Галерея профиля');
DEFINE('_UE_PROFILE_GALLERY_DESC','Эта вкладка содержит элементарную и без излишеств галерею картинок для профилей CB');
...
// 1.2 CB beta 8+9+10:
DEFINE('_UE_AVATAR_DISCLAIMER','Щелкая "%s", Вы подтверждаете что у Вас есть право использовать эту картинку.');
DEFINE('_UE_AVATAR_DISCLAIMER_TERMS','Щелкая "%s", Вы подтверждаете что у Вас есть право использовать эту картинку и что это не нарушает %s.');
DEFINE('_UE_AGE','Возраст');
DEFINE('_UE_CLOAKED','Этот адрес эл.почты защищен от спам-роботов. Вы должны разрешить JavaScript на Вашем браузере чтобы увидеть его.');
DEFINE ('_UE_YEAR','год');
...
// 1.2 CB RC 2 beta 2:
DEFINE('_UE_USERNAME_OR_EMAIL','Имя пользователя или адрес эл.почты');
