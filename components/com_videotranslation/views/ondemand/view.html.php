...
class VideoTranslationViewOnDemand extends JViewLegacy
{
	function display($tpl = null) 
	{
        ...
        if($this->is_time > 0) {
            ...
            $document->addScript(JURI::base().'components/com_videotranslation/js/webrtc.js');
