...
class VideoTranslationViewLanguage extends JViewLegacy
{
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title($isNew ? 'Add new Language'
			: 'Edit Language', 'languages');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($isNew ? 'Add new Language' : 'Edit Language');
