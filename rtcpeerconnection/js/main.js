...
var socket = io.connect('http://78.140.138.8:2888');
...
socket.on('gotAnswer', function (remoteDescription) {
    ...
    remotePeerConnection.setRemoteDescription(remoteDescription);
...
function gotLocalDescription(description){
    ...
    //console.log('remote description: ', remoteDescription.sdp);
    localPeerConnection.setLocalDescription(description);
    trace("Offer from localPeerConnection: \n" + description.sdp);


    socket.emit('call', description);
